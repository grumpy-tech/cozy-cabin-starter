...
const Index = () => {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* HERO SECTION - Image background with text on right */}
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <motion.div
              ...
              className="bg-slate-900/80 backdrop-blur-md p-8 md:p-12 rounded-lg border border-amber-500/20"
            >
              <p className="text-amber-400 text-sm md:text-base font-semibold tracking-wide uppercase mb-3">
      ...
      {/* WHAT YOUR DAYS LOOK LIKE - 3 Columns */}
