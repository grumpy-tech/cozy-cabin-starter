...
const Index = () => {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* HERO SECTION - UPDATED: No blue box, brighter image, text with drop shadows */}
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            {/* Text Content - Right Side - REMOVED background box, added drop shadows */}
            <motion.div
            ...
            >
              <p className="text-amber-400 text-sm md:text-base font-semibold tracking-wide uppercase mb-3 drop-shadow-lg">
                Founded by Cycle Logic
              </p>
              
              <h1 className="font-heading text-3xl md:text-5xl lg:text-6xl text-white font-bold mb-6 leading-tight drop-shadow-2xl">
                Colombia's Ultimate
                <br />
                <span className="text-amber-400">Cycling Experience</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-6 justify-end">
                <Button 
                  ...
                  size="lg" 
                  className="bg-amber-500 hover:bg-amber-600 text-white text-lg px-8 py-6 shadow-2xl"
                >
                  View Tour Dates
                </Button>
                <Button 
                  ...
                  variant="outline" 
                  size="lg" 
                  className="bg-white/90 border-white text-gray-900 hover:bg-white text-lg px-8 py-6 shadow-2xl"
                >
                  Get In Touch
                </Button>
              </div>
      ...
      {/* YOUR MOUNTAIN RETREAT - UNCHANGED */}
      ...
      {/* WHAT YOUR DAYS LOOK LIKE - UNCHANGED */}
